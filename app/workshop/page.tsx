...
export default function Workshop() {
  const entries: MediaProps[] = [
    ...
    },
    {
      ...
      description: (
        <>
          The Spring 2025 hackathon from{" "}
          <Link href="https://compsigh.club">compsigh</Link>, the social
          computer science club at the University of San Francisco. I
          coordinated logistics around judging, sponsorships, etc. as well as
          led branding &amp; design-engineering for the platform. Full write-up
          coming soon™
          <ul>
            <li>
              <Link href="https://www.figma.com/design/aEMV4laiF3RSIgap6rEm9N/BLOOM?node-id=0-1&t=2lGPt6Du42EmiRor-1">
                Check out the Figma file
              </Link>
            </li>
            <li>
              <Link href="https://www.cosmos.so/edwardshturman/bloom">
                Explore the design moodboard on Cosmos
              </Link>
            </li>
          </ul>
        </>
    ...
    },
    {
      ...
      description: (
        <>
          ...
          <Mention
            name="Cal"
            avatar="/avatars/cal.jpeg"
            link="https://calum-crawford.com"
          />
          ,{" "}
          <Mention
            name="Dave"
            avatar="/avatars/dave.jpeg"
            link="https://davidshubov.com"
          />
          , and{" "}
          <Mention
            name="Karl"
            avatar="/avatars/karl.jpeg"
            link="https://www.linkedin.com/in/karl-hu-josefsson-95998a300"
          />{" "}
          for our senior team project at the University of San Francisco. I led
          art direction and designed assets.
          <ul>
            <li>
              <Link href="https://www.figma.com/design/j62xk19LxQn3NrzG78MJZK/Blink?node-id=0-1&t=6FsJO0wW2nMZD0hl-1">
                Check out the Figma file
              </Link>
            </li>
            <li>
              <Link href="https://www.cosmos.so/edwardshturman/blink">
                Explore the design moodboard on Cosmos
              </Link>
            </li>
            <li>
              <Link href="https://open.spotify.com/playlist/78XdW3O54FP6O0aMyYgZSE?si=992911895b8e431b">
                Listen to the sound moodboard on Spotify
              </Link>
            </li>
          </ul>
        </>
    ...
    },
    {
      ...
      description: (
        <>
          A workshop I led for <Link href="/projects/compsigh">compsigh</Link>,
          the computer science club at the University of San Francisco, about
          why working on projects and sharing them online is so important as a
          CS major. Designed this graphic too.
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          Leadership documentation homepage for{" "}
          <Link href="/projects/compsigh">compsigh</Link>, the computer science
          club at the University of San Francisco
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          Graphics for the{" "}
          <Link href="https://instagram.com/p/DBaOcC6vdSb">
            Instagram post from DEPLOY/24
          </Link>
    ...
    },
    {
      ...
      description:
        "A search engine built using Information Retrieval techniques for my software development class",
    ...
    },
    {
      ...
      description: (
        <>
          Work in progress on a new web platform for{" "}
          <Link href="/projects/compsigh">compsigh</Link>, the computer science
          club at the University of San Francisco. Members open a PR with just a
          Markdown file and can share their work anywhere. Decorations — inside
          jokes, soundbites, Discord server emotes — are strewn across the
          margins to make the page feel more personal.
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          A flyer for <Link href="/projects/compsigh">compsigh</Link>, the
          computer science club at the University of San Francisco. We handed
          these out at our university&apos;s annual Spring event for incoming
          freshmen.
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          A platform I design-engineered with{" "}
          <Mention
            name="Gursh"
            avatar="/avatars/gursh.png"
            link="https://gursh.dev"
          />{" "}
          to host a coding riddle competition for{" "}
          <Link href="/projects/compsigh">compsigh</Link>, the computer science
          club at the University of San Francisco. Fit with auth via NextAuth,
          event flags via Vercel Edge Config, and teams + invites + leaderboard
          via Vercel Postgres.
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          A set of 4K AI-generated wallpapers from{" "}
          <Link href="/projects/deploy23">DEPLOY/23</Link>, a hackathon hosted
          by <Link href="/projects/compsigh">compsigh</Link>, the computer
          science club at the University of San Francisco
        </>
      ),
      src: "/assets/2033.png",
    ...
    },
    {
      ...
      description: (
        <>
          A logo for the{" "}
          <Link href="https://www.usfca.edu/arts-sciences/research/facilities-labs/innovation-hive">
            Innovation Hive
          </Link>{" "}
          maker space at the University of San Francisco
        </>
      ),
      src: "/assets/hive.png",
    ...
    },
    {
      ...
      description: (
        <>
          <>
            A set of 10 high-quality icons modeled after the GitHub contribution
            chart you can upload to your Slack workspace or Discord server as
            emojis!
          </>
    ...
    },
    {
      ...
      description: (
        <>
          A set of avatars I generated with{" "}
          <Link href="https://midjourney.com">Midjourney</Link> for the Fall
          2023 leadership cohort of{" "}
          <Link href="/projects/compsigh">compsigh</Link>, the computer science
          club at the University of San Francisco
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          A set of vector icons I generated with{" "}
          <Link href="https://recraft.ai">Recraft</Link> for{" "}
          <Link href="/projects/compsigh">compsigh</Link>, the computer science
          club at the University of San Francisco
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          A distilled version of a workshop I ran for{" "}
          <Link href="/projects/compsigh">compsigh</Link>, the computer science
          club at the University of San Francisco, on why engineers should
          design, and how to start
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          Generated with <Link href="https://midjourney.com">Midjourney</Link>
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          Fictitious fashion collection exploring traditional Ukrainian
          vyshyvanka, modernized. Generated with{" "}
          <Link href="https://midjourney.com">Midjourney</Link>.
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          Style popular websites based on your{" "}
          <Link href="https://arc.net/gift/6a6a1565">Arc</Link> theme
        </>
      ),
