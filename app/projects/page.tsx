  ...
  return (
    <>
      ...
      <GalleryCard
        ...
        description={
          <>
            <p>The computer science club I founded at the University of San Francisco for meeting cool people &amp; building cool things</p>
          </>
        }
        src={`/og/compsigh.png`}
        alt={`compsigh banner`}
      ...
      <GalleryCard
        ...
        description={
          <>
            <p>The first hackathon hosted by <Link href={`/projects/compsigh`}>compsigh</Link> — the computer science club at the University of San Francisco — and our biggest event of the Fall 2023 semester. An entirely student-bootstrapped, three-day event, bringing together the best minds in CS, design, and engineering to hack on a project for a weekend.</p>
          </>
        }
        src={`/og/deploy23.png`}
